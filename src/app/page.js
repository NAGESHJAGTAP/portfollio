...
const actions = [
  { icon: <InstagramIcon />, name: "Instagram", link: "https://www.instagram.com/nagesh_jagtap009/" },
  { icon: <WhatsAppIcon />, name: "WhatsApp", link: "https://api.whatsapp.com/send/?phone=8999301793&text=Hey+there+%2C+can+we+talk..&type=phone_number&app_absent=0" },
  { icon: <LinkedInIcon />, name: "LinkedIn", link: "https://www.linkedin.com/in/nagesh-jagtap-9bb56031a/" },
  { icon: <GitHubIcon />, name: "GitHub", link: "https://github.com/Nageshjagtap" },
];
